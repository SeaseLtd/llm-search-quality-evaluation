...
[Embedding Model Evaluator](../embedding_model_evaluator/README.md) module. The goal is to test the ANN
...
> [constants.py](constants.py). By defaults, uses the latest version supported:
