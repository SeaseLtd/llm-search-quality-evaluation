...
Create a [config.yaml](../../../examples/configs/dataset_generator/dataset_generator_config.yaml) file in the `dataset_generator` 
...
> - **max_query_terms** (Optional): Max number of query terms to be generated by the LLM
...
Fill [LLM configuration file](../../../examples/configs/dataset_generator/llm_config.yaml) with your information and create the `.env` file in dataset-generator 
folder with your own API key.

Place yourself in the directory of the project and create a `.env` file to store the API key:
