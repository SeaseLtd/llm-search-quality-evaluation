...
def test_llm_service_generate_queries__expects__response(example_doc):
    ...
    fake_llm = FakeListChatModel(
        responses=['{"queries": ["Car","Auto","Vehicle","Sedan","Toyota"]}']
    )
...
def test_llm_service_generate_score_with_invalid_responses__expects__raises_value_error(
    example_doc, invalid_response
):
